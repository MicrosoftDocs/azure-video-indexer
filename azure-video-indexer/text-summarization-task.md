...
If you get a filter not found error, you will get a detailed error describing what is missing. The error will look similar to this, but might have details about other missing things:
