...
OCR currently extracts insights from printed and handwritten text in over 50 languages, including from an image with text in multiple languages. For more information, see [OCR supported languages](/ai-services/computer-vision/language-support#optical-character-recognition-ocr).    
...
For more information, see [OCR technology](/ai-services/computer-vision/overview-ocr). 
