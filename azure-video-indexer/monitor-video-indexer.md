...
> [!NOTE]
> The monitoring feature is not available for trial and classic accounts. To update to an ARM account, see the [migration guide](azure-video-indexer-ams-retirement-guide.md).
