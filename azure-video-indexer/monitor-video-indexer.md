...
> [!NOTE]
> The monitoring feature is not available for trial accounts. To update to an ARM account, see the [migration guide](azure-video-indexer-ams-retirement-guide.md).
