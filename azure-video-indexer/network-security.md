...
> [!NOTE]
> The NSG service tags feature is not available for trial accounts. To update to an ARM account, see the [migration guide](azure-video-indexer-ams-retirement-guide.md) or [Import content from a trial account](import-content-from-trial.md).
